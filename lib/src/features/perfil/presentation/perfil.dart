...
class _PerfilAlumnoState extends State<PerfilAlumno> {
  ...
  String _profileImageUrl = 'https://googleflutter.com/sample_image.jpg'; //
        ...
        children: [
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                filled: true,
                fillColor: _isDarkMode ? Color(0xFF343646) : Colors.white,
                border: OutlineInputBorder(
                  borderSide: BorderSide(
                    color: isEditable ? Color(0xff2a2c3e) : Colors.transparent,
                  ),
                ),
                isDense: true,
                contentPadding:
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: _isDarkMode ? Color(0xFF272A3C) : Colors.white,
              textStyle: TextStyle(fontSize: 12, fontFamily: 'ABeeZee'),
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildEditableField(
              ...
              onEdit: () {
                setState(() {
                  _isRecoveryEmailEditable = !_isRecoveryEmailEditable;
                });
              },
            ),
            Divider(color: Color(0xFF343646), thickness: 2),
            ...
            Center(
              child: ElevatedButton(
                        ...
                        actions: <Widget>[
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              _surnameController.text = "ApellidoAlumno";
                              _emailController.text = "Alumno@gmail.com";
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      _isDarkMode ? Color(0xFF272A3C) : Colors.white,
                  textStyle: TextStyle(fontSize: 14, fontFamily: 'ABeeZee'),
                ),
